...
func Classroom_courses_createHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateClassroom_courses_createTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_courses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Classroom_courses_createHandler(cfg),
	}
}
